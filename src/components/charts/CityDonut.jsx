...
export default function CityDonut({ data = [] }) {
      ...
      return (
        <div className="tooltip-box">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', fontSize: '12px' }}>
            ...
            <span className="mono" style={{ fontWeight: 700, color: '#FFFFFF' }}>{formatNumberIN(item.value)}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', fontSize: '12px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h3 style={{ fontSize: '17px', color: 'var(--text-primary)' }}>City & Territory Distribution</h3>
          </div>
          <p style={{ fontSize: '12px', color: 'var(--text-secondary)', marginTop: '2px' }}>
            Geographic concentration of incoming leads
          </p>
        </div>
      </div>
      ...
      <div style={{ position: 'relative', width: '100%', height: '220px' }}>
        {total === 0 ? (
          ...
          <>
            ...
            >
              <div style={{ fontSize: '24px', fontWeight: 800, color: 'var(--text-primary)', lineHeight: 1.1 }} className="mono">
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', overflow: 'hidden' }}>
                ...
                <span style={{ fontSize: '12px', color: 'var(--text-secondary)', fontWeight: 600, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>
                  {item.name}
                </span>
              </div>
